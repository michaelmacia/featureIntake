 ...
 * Loaded by the browser (window.IntakeRules) and by the server (require).
 * Keep this file dependency-free so both runtimes execute the exact same rules.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) module.exports = factory();
  else root.IntakeRules = factory();
  ...
  return { ENUMS, TRANSITIONS, OPEN_STATUSES, TEXT_LIMITS, validateRequest, computePriority, canTransition, isValidDate };
});
