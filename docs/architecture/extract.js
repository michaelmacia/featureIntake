...
const SOURCES = {
  '02-solution-architecture.md': ['01-system-context', '02-mvp-containers', '03-seq-submit-request', '04-seq-triage-decision', '04a-seq-assistant-intake', '04b-seq-concept-mock', '05-request-lifecycle', '06-target-architecture', '07-deployment-pipeline'],
