...
const EPICS = [
  ...
  { key: 'E6', name: 'AI Concept Mocks', release: 'MVP', summary: 'Every submission gets an AI-generated concept mock UI that the requester and triage can see and refine.' },
  { key: 'E7', name: 'AI-Guided Intake', release: 'MVP', summary: 'Requesters describe what they need in their own words; an assistant asks follow-ups and builds a complete, structured request with them.' },
];
...
const STORIES = [
  ...
  ['E6', 'Generate a concept mock on submission', 5, 'High', 'backend,ai',
  ...
  ['E6', 'Show the mock on the confirmation screen', 3, 'High', 'frontend,ai',
  ...
  ['E6', 'Regenerate the mock with feedback', 3, 'Medium', 'frontend,backend,ai',
  ...
  ['E6', 'Show the mock in the triage detail view', 2, 'Medium', 'frontend,triage,ai',
  ...
  ['E6', 'Sandbox generated HTML', 3, 'Highest', 'security,ai',
  ...
  ['E6', 'Mock cost and quality monitoring', 2, 'Low', 'observability,ai',
  ...
  ['E7', 'Describe-it-first start screen', 2, 'High', 'frontend,ai,intake',
  ...
  ['E7', 'Intake assistant turn API', 5, 'Highest', 'backend,ai',
  ...
  ['E7', 'Guided follow-up questions and suggestions', 3, 'High', 'ai,intake',
  ...
  ['E7', 'Live, editable request panel', 5, 'High', 'frontend,intake',
  ...
  ['E7', 'Keep the conversation with the request', 2, 'Medium', 'backend,triage,ai',
  ...
  ['E7', 'Resilience and fallback', 2, 'Medium', 'frontend,backend,ai',
